...
class Inputs extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $data['title']              = 'Apotik Medika - List Obat Masuk';
        $data['breadcrumb_title']   = 'List Obat Masuk';
        $data['breadcrumb_path']    = 'Obat Masuk / List Obat Masuk';
        ...
        $data['content'] = $this->Inputs_model->keluar_detail();
    ...
    public function search($page = null)
    {
        ...
        $data['title']              = 'Apotik Medika - List Barang Masuk';
    ...
    public function search_time($page = null)
    {
        ...
        $data['title']              = 'Apotik Medika - List Obat Masuk';
        $data['breadcrumb_title']   = "List Obat Masuk";
        $data['breadcrumb_path']    = "Obat Masuk / List Obat Masuk / Filter / $time";
        $data['content']            = $this->inputs->select([
            'barang_masuk.id', 'user.nama',
            'barang_masuk.waktu', 'barang_masuk.total_harga'
        ])
    ...
    {
        $data['title']              = 'Apotik Medika - Detail Obat Masuk';
        $data['breadcrumb_title']   = "Detail Obat Masuk";
        $data['breadcrumb_path']    = "Obat Masuk / List Obat Masuk / Detail Barang Masuk / $id_barang_masuk";
    ...
    public function print_barang_masuk(){
        $data['title'] = "Data Semua Barang Masuk";
        $data['barang_masuk'] = $this->db->get('detail_barang_masuk')->result_array();
        
        $this->load->view('pages/inputs/print', $data);
    }

    public function cari_tanggal(){
        $data['title'] = "Data Barang Masuk";
        $mulai =  $this->input->post('awal');
        $selesai = $this->input->post('selesai');
        $data['barang_masuk'] = $this->db->query("SELECT * FROM detail_barang_masuk WHERE  waktu BETWEEN '$mulai' AND '$selesai'")->result_array();
