...
class Outputs extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $data['title']              = 'Apotik Medika - List Obat Keluar';
        $data['breadcrumb_title']   = 'List Obat Keluar';
        $data['breadcrumb_path']    = 'Obat Keluar / List Obat Keluar';
        ...
        $data['content'] = $this->Outputs_model->keluar_barang();
    ...
    public function search($page = null)
    {
        ...
        $data['title']              = 'Apotik Medika - List Obat Keluar';
        $data['breadcrumb_title']   = 'List Obat Keluar';
        $data['breadcrumb_path']    = "Obat Keluar / List Obat Keluar / Cari / $keyword";
        $data['content']            = $this->outputs->select([
            'barang_keluar.id', 'user.nama',
            'barang_keluar.waktu'
        ])
    ...
    public function search_time($page = null)
    {
        ...
        $data['title']              = 'Apotik Medika - List Obat Keluar';
        $data['breadcrumb_title']   = 'List Obat Keluar';
        $data['breadcrumb_path']    = "Obat Keluar / List Obat Keluar / Filter / $time";
        $data['content']            = $this->outputs->select([
            'barang_keluar.id', 'user.nama',
            'barang_keluar.waktu'
        ])
    ...
    public function detail($id_barang_keluar)
    {
        $data['title']              = 'Apotik Medika - List Obat Keluar';
        $data['breadcrumb_title']   = 'List Obat Keluar';
        $data['breadcrumb_path']    = "Obat Keluar / List Obat Keluar / Detail / $id_barang_keluar";
    ...
    public function print_barang_keluar(){
        $data['title'] = "Data Semua Barang Keluar";
        $data['barang_masuk'] = $this->db->get('detail_barang_keluar')->result_array();
        
        $this->load->view('pages/outputs/print', $data);
    }
    ...
    public function cari_tanggal(){
        ...
        $data['barang_masuk'] = $this->db->query("SELECT * FROM detail_barang_keluar WHERE  waktu BETWEEN '$mulai' AND '$selesai'")->result_array();
