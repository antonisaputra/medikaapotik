...
class Unit extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        if (!$this->unit->validate()) {     // Jika validasi gagal maka arahkan ke form register lagi
            $data['title'] = 'Apotik Medika - Tambah Kemasan';
            $data['input'] = $input;
            $data['page']  = 'pages/unit/index';
            $data['breadcrumb_title'] = 'Tambah Kemasan';
            $data['breadcrumb_path']  = 'Manajemen Barang / Tambah Kemasan';
        ...
        if ($this->unit->run($input)) {
            $this->session->set_flashdata('success', 'Kemasan berhasil ditambahkan');
