...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Register Obat Baru</h4>
                    <form action="<?= base_url('item') ?>" method="POST">
                        <div class="form-body">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <label class="input-group-text" for="kategori-options"><i class="fas fa-box"></i></label>
                                                    </div>
                                                    <select class="form-control" name="id_kategori" id="kategori-options">
                                                        <?php foreach (getKategori() as $kategori) : ?>
                                                            <option value="<?= $kategori->id ?>" <?= $input->id == $kategori->id ? 'selected' : '' ?>>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-lg-2">Kemasan</label>
                                    <div class="col-lg-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
