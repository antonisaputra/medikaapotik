            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">List Kemasan Barang</h4>
                    </div>
                    <div class="table-responsive">
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
                                <tr class="border-0">
                                    <th class="border-0 font-14 font-weight-medium text-muted text-center px-2">Nama Kemasan</th>
                                    <th class="border-0 font-14 font-weight-medium text-muted text-center">Status Kemasan</th>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin') : ?>
                                            <td class="border-top-0 text-center text-muted px-2 py-4">
                                                ...
                                                <a href="<?= base_url("units/hapus/$row->id") ?>" class="btn btn-sm">
