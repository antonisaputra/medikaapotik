        ...
        <div class="col-lg-12 ">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="d-inline text-dark">Filter kemasan&nbsp;&#8594;&nbsp;</h5>
                            <span>
            ...
            <div class="col-md-6">
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Kategori: <?= $row->nama_kategori ?></p>
                        ...
                        <a href="<?= base_url("items/hapus/$row->id_barang") ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fas fa-trash-alt"></i></a>
                        <div class="row">
