...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">List Pemasukan Obat</h4>
                    </div>
        ...
        <div class="card-footer bg-white">
            <div class="row">
                <a href="<?= base_url(); ?>Inputs/print_barang_masuk" class="btn btn-success btn-rounded float-right">Cetak Laporan <i class="fas fa-angle-right"></i></a>
            </div>
            <div class="d-flex">
                <form action="<?= base_url(); ?>Inputs/cari_tanggal" method="post">
                    <div class="row mt-3">
                        <div class="col">
