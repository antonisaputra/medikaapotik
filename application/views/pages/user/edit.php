...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Formulir Profil <?= $input->nama ?></h4>
                    <form action="<?= base_url("user/edit/$input->id") ?>" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <?= form_input('telefon', $input->telefon, ['class' => 'form-control', 'placeholder' => 'Masukan nomor telepon aktif', 'required' => true]) ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                        ...
                        <div class="form-actions">
                            <div class="text-right">
                                ...
                                <a href="<?= base_url('user') ?>" class="btn btn-dark">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
