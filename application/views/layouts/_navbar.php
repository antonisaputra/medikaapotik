    ...
    <nav class="navbar top-navbar navbar-expand-md">
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="<?= base_url('home') ?>">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img src="#" height="40" alt="logo" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="" height="40" alt="logo" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    </span>
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-right">
                ...
                <?php elseif ($this->uri->segment(1) == 'kategories') : ?>
                    <li class="nav-item d-none d-md-block">
                        <a class="nav-link">
                            <form action="<?= base_url('kategories/search') ?>" method="POST">
                                <div class="customize-input">
                                    <input name="keyword" class="form-control custom-shadow custom-radius border-0 bg-white" type="search" placeholder="Search" aria-label="Search" value="<?= $this->session->userdata('keyword') ?>">
                                    <i class="form-control-icon" data-feather="search"></i>
                                </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <a class="dropdown-item" href="<?= base_url("user") ?>">
                            <i data-feather="user" class="svg-icon mr-2 ml-1"></i>Profil
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?= base_url("user/edit/" . $this->session->userdata('id_user')) ?>">
                            <i data-feather="settings" class="svg-icon mr-2 ml-1"></i>Pengaturan Akun
                        </a>
                        <div class="dropdown-divider"></div>
