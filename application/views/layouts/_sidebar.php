    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="nav-small-cap"><span class="hide-menu">Manajemen Kategori</span></li>
                ...
                <?php endif ?>
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?= base_url('kategories') ?>" aria-expanded="false">
                ...
                <li class="nav-small-cap"><span class="hide-menu">Manajemen Obat</span></li>
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('item') ?>" aria-expanded="false">
                            <i data-feather="clipboard" class="feather-icon"></i>
                            <span class="hide-menu">Tambah Obat</span>
                        </a>
                    </li>
                <?php endif ?>
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?= base_url('items') ?>" aria-expanded="false">
                        <i data-feather="package" class="feather-icon"></i>
                        <span class="hide-menu">List Obat</span>
                    </a>
                </li>
                <?php if ($this->session->userdata('role') == 'admin') : ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= base_url('unit') ?>" aria-expanded="false">
                            ...
                            <span class="hide-menu">Tambah Kemasan</span>
                        </a>
                    </li>
                <?php endif ?>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?= base_url('units') ?>" aria-expanded="false">
                        ...
                        <span class="hide-menu">List Kemasan</span>
                    </a>
                </li>
                ...
                <!-- Submemu Barang -->
                <li class="nav-small-cap"><span class="hide-menu">Obat Masuk</span></li>
                <li class="sidebar-item">
                ...
                <li class="nav-small-cap"><span class="hide-menu">Obat Keluar</span></li>
                <li class="sidebar-item">
